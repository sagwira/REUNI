-- Final fix - don't cast UUIDs to TEXT, keep them as UUIDs
...
BEGIN
    ...
    -- Create buyer's ticket - all UUIDs stay as UUIDs
    RETURN QUERY
...
SELECT 'Function fixed - all UUIDs kept as UUIDs!' as status;
