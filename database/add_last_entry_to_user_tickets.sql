...
-- Update existing tickets to set last_entry based on event_date if not already set
-- This is a best-effort update for existing data
UPDATE user_tickets
SET last_entry = event_date::timestamptz
WHERE last_entry IS NULL AND event_date IS NOT NULL;
