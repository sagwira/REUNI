-- Final fix: Database columns are UUID, not TEXT!
-- Remove all ::text casts from INSERT
...
BEGIN
    ...
    -- Create the buyer's ticket (NO ::text casts - columns are UUID!)
    RETURN QUERY
...
SELECT 'Function recreated with UUID types!' as status;
